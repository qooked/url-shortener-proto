...
func (x *ShortenURLRequest) Reset() {
	*x = ShortenURLRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shortener_web_shortener_web_proto_msgTypes[0]
...
func (*ShortenURLRequest) Descriptor() ([]byte, []int) {
	return file_shortener_web_shortener_web_proto_rawDescGZIP(), []int{0}
}
...
func (x *ShortenURLResponse) Reset() {
	*x = ShortenURLResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shortener_web_shortener_web_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ShortenURLResponse) Descriptor() ([]byte, []int) {
	return file_shortener_web_shortener_web_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetURLRequest) Reset() {
	*x = GetURLRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shortener_web_shortener_web_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetURLRequest) Descriptor() ([]byte, []int) {
	return file_shortener_web_shortener_web_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetURLResponse) Reset() {
	*x = GetURLResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shortener_web_shortener_web_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetURLResponse) Descriptor() ([]byte, []int) {
	return file_shortener_web_shortener_web_proto_rawDescGZIP(), []int{3}
}
...
var File_shortener_web_shortener_web_proto protoreflect.FileDescriptor

var file_shortener_web_shortener_web_proto_rawDesc = []byte{
	0x0a, 0x21, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x5f, 0x77, 0x65, 0x62, 0x2f,
	0x73, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x5f, 0x77, 0x65, 0x62, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x03, 0x77, 0x65, 0x62, 0x22, 0x25, 0x0a, 0x11, 0x53, 0x68, 0x6f, 0x72,
	...
	0x55, 0x52, 0x4c, 0x12, 0x16, 0x2e, 0x77, 0x65, 0x62, 0x2e, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x65,
	0x6e, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x77, 0x65,
	0x62, 0x2e, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x65, 0x6e, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x31, 0x0a, 0x06, 0x47, 0x65, 0x74, 0x55, 0x52, 0x4c, 0x12, 0x12,
	0x2e, 0x77, 0x65, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x52, 0x4c, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x13, 0x2e, 0x77, 0x65, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x52, 0x4c, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x77, 0x65, 0x62, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_shortener_web_shortener_web_proto_rawDescOnce sync.Once
	file_shortener_web_shortener_web_proto_rawDescData = file_shortener_web_shortener_web_proto_rawDesc
)

func file_shortener_web_shortener_web_proto_rawDescGZIP() []byte {
	file_shortener_web_shortener_web_proto_rawDescOnce.Do(func() {
		file_shortener_web_shortener_web_proto_rawDescData = protoimpl.X.CompressGZIP(file_shortener_web_shortener_web_proto_rawDescData)
	})
	return file_shortener_web_shortener_web_proto_rawDescData
}

var file_shortener_web_shortener_web_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_shortener_web_shortener_web_proto_goTypes = []interface{}{
	(*ShortenURLRequest)(nil),  // 0: web.ShortenURLRequest
	(*ShortenURLResponse)(nil), // 1: web.ShortenURLResponse
	(*GetURLRequest)(nil),      // 2: web.GetURLRequest
	(*GetURLResponse)(nil),     // 3: web.GetURLResponse
}
var file_shortener_web_shortener_web_proto_depIdxs = []int32{
	0, // 0: web.Shortener.ShortenURL:input_type -> web.ShortenURLRequest
	2, // 1: web.Shortener.GetURL:input_type -> web.GetURLRequest
	1, // 2: web.Shortener.ShortenURL:output_type -> web.ShortenURLResponse
	3, // 3: web.Shortener.GetURL:output_type -> web.GetURLResponse
...
func init() { file_shortener_web_shortener_web_proto_init() }
func file_shortener_web_shortener_web_proto_init() {
	if File_shortener_web_shortener_web_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_shortener_web_shortener_web_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shortener_web_shortener_web_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shortener_web_shortener_web_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shortener_web_shortener_web_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_shortener_web_shortener_web_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*ShortenURLResponse_ShortenedURL)(nil),
		(*ShortenURLResponse_Error)(nil),
	}
	file_shortener_web_shortener_web_proto_msgTypes[3].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_shortener_web_shortener_web_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_shortener_web_shortener_web_proto_goTypes,
		DependencyIndexes: file_shortener_web_shortener_web_proto_depIdxs,
		MessageInfos:      file_shortener_web_shortener_web_proto_msgTypes,
	}.Build()
	File_shortener_web_shortener_web_proto = out.File
	file_shortener_web_shortener_web_proto_rawDesc = nil
	file_shortener_web_shortener_web_proto_goTypes = nil
	file_shortener_web_shortener_web_proto_depIdxs = nil
}
